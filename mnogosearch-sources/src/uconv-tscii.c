...
int 
udm_mb_wc_tscii(UDM_CONV *conv, UDM_CHARSET *cs, int *pwc,
                const unsigned char *s, const unsigned char *e)
{
  ...
  pwc[(unsigned char) conv->istate + 1]= 0;
  return 1;
}

int udm_wc_mb_tscii(UDM_CONV *conv, UDM_CHARSET *cs,
                    int *wc, unsigned char *s, unsigned char *e)
{
  if (*wc < 0x7F)
  {
    s[0] = *wc;
  ...
  case 0xb95:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xec; break;
      case 0x0bc2: s[0]= 0xdc; break;
      case 0x0bc1: s[0]= 0xcc; break;
      default: s[0]= 0xb8;
    }
    break;
  case 0xb99:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xed; break;
      case 0x0bc2: s[0]= 0x9b; break;
      case 0x0bc1: s[0]= 0x99; break;
      default: s[0]= 0xb9;
    }
    break;
  case 0xb9a:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xee; break;
      case 0x0bc1: s[0]= 0xcd; break;
      case 0x0bc2: s[0]= 0xdd; break;
      default: s[0]= 0xba;
    }
    break;
  case 0xb9c:
  ...
  case 0xb9e:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xef; break;
      case 0x0bc1: s[0]= 0x9a; break;
      case 0x0bc2: s[0]= 0x9c; break;
      default: s[0]= 0xbb;
    }
    break;
  case 0xb9f:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xf0; break;
      case 0x0bbf: s[0]= 0xca; break;
      case 0x0bc0: s[0]= 0xcb; break;
      case 0x0bc1: s[0]= 0xce; break;
      case 0x0bc2: s[0]= 0xde; break;
      default: s[0]= 0xbc;
    }
    break;
  case 0xba1:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xf2; break;
      default: return UDM_CHARSET_ILUNI;
    }
    break;
  case 0xba3:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xf1; break;
      case 0x0bc1: s[0]= 0xcf; break;
      case 0x0bc2: s[0]= 0xdf; break;
      default: s[0]= 0xbd;
    }
    break;
  case 0xba4:
    switch(wc[1])
    {
      case 0x0bc1: s[0]= 0xd0; break;
      case 0x0bc2: s[0]= 0xe0; break;
      default: s[0]= 0xbe;
    }
    break;
  case 0xba8:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xf3; break;
      case 0x0bc1: s[0]= 0xd1; break;
      case 0x0bc2: s[0]= 0xe1; break;
      default: s[0]= 0xbf;
    }
    break;
  case 0xba9:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xfd; break;
      case 0x0bc1: s[0]= 0xdb; break;
      case 0x0bc2: s[0]= 0xeb; break;
      default: s[0]= 0xc9;
    }
    break;
  case 0xbaa:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xf4; break;
      case 0x0bc1: s[0]= 0xd2; break;
      case 0x0bc2: s[0]= 0xe2; break;
      default: s[0]= 0xc0;
    }
    break;
  case 0xbae:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xf5; break;
      case 0x0bc1: s[0]= 0xd3; break;
      case 0x0bc2: s[0]= 0xe3; break;
      default: s[0]= 0xc1;
    }
    break;
  case 0xbaf:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xf6; break;
      case 0x0bc1: s[0]= 0xd4; break;
      case 0x0bc2: s[0]= 0xe4; break;
      default: s[0]= 0xc2;
    }
    break;
  case 0xbb0:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xf7; break;
      case 0x0bc1: s[0]= 0xd5; break;
      case 0x0bc2: s[0]= 0xe5; break;
      default: s[0]= 0xc3;
    }
    break;
  case 0xbb1:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xfc; break;
      case 0x0bc1: s[0]= 0xda; break;
      case 0x0bc2: s[0]= 0xea; break;
      default: s[0]= 0xc8;
    }
    break;
  case 0xbb2:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xf8; break;
      case 0x0bc1: s[0]= 0xd6; break;
      case 0x0bc2: s[0]= 0xe6; break;
      default: s[0]= 0xc4;
    }
    break;
  case 0xbb3:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xfb; break;
      case 0x0bc1: s[0]= 0xd9; break;
      case 0x0bc2: s[0]= 0xe9; break;
      default: s[0]= 0xc7;
    }
    break;
  case 0xbb4:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xfa; break;
      case 0x0bc1: s[0]= 0xd8; break;
      case 0x0bc2: s[0]= 0xe8; break;
      default: s[0]= 0xc6;
    }
    break;
  case 0xbb5:
    switch(wc[1])
    {
      case 0x0b82: s[0]= 0xf9; break;
      case 0x0bc1: s[0]= 0xd7; break;
      case 0x0bc2: s[0]= 0xe7; break;
      default: s[0]= 0xc5;
    }
    break;
  case 0xbb7:
